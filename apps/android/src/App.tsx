...
function AppContent() {
  ...
  return (
    <div className="h-full flex flex-col android-safe-top">
      {/* Navigation Bar */}
      <nav className="bg-primary-700 text-white flex items-center justify-between px-4 py-2">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={logout}
            className="px-3 py-1 bg-red-500 hover:bg-red-600 active:bg-red-700 rounded-lg text-sm font-medium"
          >
            Logout
          </button>
        </div>
      ...
      {/* Page Content */}
      <div className="flex-1 overflow-hidden android-safe-bottom">
